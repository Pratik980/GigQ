...
This test file should be placed at: tests/test_table_formatter.py
"""
import unittest
...
class TestTableFormatter(unittest.TestCase):
    ...
    def test_format_table_with_headers(self):
        ...
        lines = result.split("\n")
        self.assertEqual(lines[0], lines[2])  # First separator equals the one after header
        
        # Count the actual number of lines (don't hardcode the count)
